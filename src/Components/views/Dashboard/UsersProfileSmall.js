                  ...
                  <div className="col-sm-5">
                    <div className="user-profile compact">
                      <div
                        className="up-head-w"
                        style={{
                          "background-image": "url(img/profile_bg1.jpg)",
                        }}
                      >
                            ...
                            <div className="ta-record-w">
                              <div className="ta-record">
                                ...
                                <div className="ta-activity">
                                  ...
                                  <Link to="/#">Register new symbol</Link> in
                                  Rogue
                                </div>
                              </div>
                              <div className="ta-record">
                              ...
                              <div className="ta-record">
                                ...
                                <div className="ta-activity">
                                  Added <Link to="/#">John Silver</Link> as a
                                  friend
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="element-info-with-icon">
                              ...
                              <div className="element-info-text">
                                ...
                                <div className="element-inner-desc">
                                  ...
                                  <Link
                                    to="/http://1000hz.github.io/bootstrap-validator/"
                                    target="_blank"
                                  >
...
export default UsersProfileSmall;
