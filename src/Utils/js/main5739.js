...
$(function () {
  ...
  $(".message-input").on("keypress", function (e) {
    if (13 == e.which) {
      $(".chat-messages").append(
        '<div class="message self"><div class="message-content">' +
          $(this).val() +
          "</div></div>"
      ),
        $(this).val("");
      ...
      return (
        t.scrollTop(t.prop("scrollHeight")), t.perfectScrollbar("update"), !1
      );
    }
  }),
      ...
      select: function e(o, a, s) {
        ...
        return (
          (n = prompt("Event Title:")) &&
            t.fullCalendar(
              "renderEvent",
              { title: n, start: o, end: a, allDay: s },
              !0
            ),
  ...
  if (
    ...
    $(".step-trigger").on("click", function () {
      ...
      if (e.length && !e.hasClass("active") && !e.hasClass("complete"))
        return !1;
      var t = $(this).attr("href");
      return (
        $(this)
          .closest(".step-triggers")
          .find(".step-trigger")
          .removeClass("active"),
    ...
    if (
      ...
      d.addColorStop(0, "rgba(30,22,170,0.08)"),
        d.addColorStop(1, "rgba(30,22,170,0)");
    ...
    if ($("#liteLineChartV2").length) {
      ...
      p.addColorStop(0, "rgba(40,97,245,0.1)"),
        p.addColorStop(1, "rgba(40,97,245,0)");
    ...
    if ($("#liteLineChartV3").length) {
      ...
      m.addColorStop(0, "rgba(40,97,245,0.2)"),
        m.addColorStop(1, "rgba(40,97,245,0)");
    ...
    if ($("#pieChart1").length) {
      ...
      new Chart(T, {
        ...
        options: {
          legend: {
            position: "bottom",
            labels: { boxWidth: 15, fontColor: "#3e4b5b" },
          },
          animation: { animateScale: !0 },
        },
      });
  ...
  if (
    ...
    $(".app-email-w").length &&
      (is_display_type("phone") || is_display_type("tablet")) &&
  ...
  if (
    ...
    $(".todo-sidebar-section-toggle").on("click", function () {
      return (
        $(this)
          .closest(".todo-sidebar-section")
          .find(".todo-sidebar-section-contents")
          .slideToggle(100),
        !1
      );
    }),
    $(".todo-sidebar-section-sub-section-toggler").on("click", function () {
      return (
        $(this)
          .closest(".todo-sidebar-section-sub-section")
          .find(".todo-sidebar-section-sub-section-content")
          .slideToggle(100),
        !1
      );
    }),
  ...
  $(".task-btn-done").on("click", function () {
    ...
    $(".close-ticket-info").on("click", function () {
      return (
        $(".support-ticket-content-w")
          .addClass("folded-info")
          .removeClass("force-show-folded-info"),
        !1
      );
    }),
    $(".show-ticket-info").on("click", function () {
      return (
        $(".support-ticket-content-w")
          .removeClass("folded-info")
          .addClass("force-show-folded-info"),
        !1
      );
    }),
    $(".support-index .support-tickets .support-ticket").on(
      "click",
      function () {
    ...
    $(".autosuggest-search-activator").on("click", function () {
      ...
      $(this).find('input[type="text"]') &&
        (e = $(this).find('input[type="text"]').offset());
      var t = e.left,
        o = e.top;
      return (
    ...
    $(".element-action-fold").on("click", function () {
      ...
      return (
        e.hasClass("folded")
          ? (t
              .removeClass("os-icon-plus-circle")
              .addClass("os-icon-minus-circle"),
            e.removeClass("folded"))
          : (t
              .removeClass("os-icon-minus-circle")
              .addClass("os-icon-plus-circle"),
            e.addClass("folded")),
        !1
      );
    });
